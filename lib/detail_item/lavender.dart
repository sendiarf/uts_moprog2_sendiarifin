...
class InstaxLavender extends StatelessWidget {
  const InstaxLavender(BuildContext context, 
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.0),
            Text(
              'The Mini 7+ is esay to use! Simply point and shoot! With its exposure control adjustment and 60mm fixed focus lens, the Mini 7+ makes it esay for you to be creative and live in the moment.',style: TextStyle(fontSize: 10),
            ),
            SizedBox(height: 8.0),
            Text(
